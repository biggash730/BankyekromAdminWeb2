  ...
  private campaignSummary() {
    ...
    this.campaignService.getConnectionSummary(this.campaignId).subscribe(res => {
      ...
      if (res.success) {
        ...
        this.makeDoughnut(this.upcomingDoughnut, this.upcomingCanvas, [res.data.upComingSchedules, res.data.totalSchedules - res.data.upComingSchedules], ['Upcoming', 'Others'], `${res.data.upComingSchedules}`, bgColor, 75)
        this.makeDoughnut(this.hangUpDoughnut, this.hangUpCanvas, [res.data.hangedUpSessions, res.data.totalSessions - res.data.hangedUpSessions], ['Hanged Up', 'Others'], `${res.data.hangedUpSessions}`, bgColor, 60)
