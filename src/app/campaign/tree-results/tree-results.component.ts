    ...
    this.treeService.getKeyMetrics(filter)
      ...
      .subscribe(res => {
        ...
        if (res.success) {
          ...
          this.completedCallsDoughnut([this.keyMetrics.completed, this.keyMetrics.calls - this.keyMetrics.completed], ['Completed', 'Not Completed'], `${this.keyMetrics.completed}`)
          this.failedCallsDoughnut([this.keyMetrics.failed, this.keyMetrics.calls - this.keyMetrics.failed], ['Failed', 'Others'], `${this.keyMetrics.failed}`)
          this.hangupCallsDoughnut([this.keyMetrics.hangup, this.keyMetrics.calls - this.keyMetrics.hangup], ['Hanged Up', 'Others'], `${this.keyMetrics.hangup}`)
