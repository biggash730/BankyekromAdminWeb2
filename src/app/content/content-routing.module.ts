...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: RouteNames.defaultAudio,
        component: DefaultAudioComponent,
        canActivate: [AuthGuard]
      },
      {
        path: RouteNames.defaultAudioForm,
        component: DefaultAudioFormComponent,
        canActivate: [AuthGuard]
      },
      {
        path: RouteNames.defaultAudioFormEdit,
        component: DefaultAudioFormComponent,
        canActivate: [AuthGuard]
      }
    ]
